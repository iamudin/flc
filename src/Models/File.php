...
{
    use Fileable;
    protected $fillable = ['file_path', 'file_type','file_auth','file_name','file_size','purpose','child_id','user_id','host','file_hits','disk','fileable_type','fileable_id','encrypt_key'];
